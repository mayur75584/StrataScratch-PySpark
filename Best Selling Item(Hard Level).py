...
554694	22921	HERB MARKER CHIVES	1	2011-05-25	1.63		United Kingdom
569545	21906	PHARMACIE FIRST AID TIN	1	2011-10-04	13.29		United Kingdom
549562	21169	YOU'RE CONFUSING ME METAL SIGN	1	2011-04-10	1.69	13232	United Kingdom
580610	21945	STRAWBERRIES DESIGN FLANNEL	1	2011-12-05	1.63		United Kingdom
558066	gift_0001_50	Dotcomgiftshop Gift Voucher £50.00	1	2011-06-24	41.67		United Kingdom
538349	21985	PACK OF 12 HEARTS DESIGN TISSUES	1	2010-12-10	0.85		United Kingdom
...
541424	84520B	PACK 20 ENGLISH ROSE PAPER NAPKINS	9	2011-01-17	1.63		United Kingdom
...
579777	22356	CHARLOTTE BAG PINK POLKADOT	4	2011-11-30	1.63		United Kingdom
566060	21106	CREAM SLICE FLANNEL CHOCOLATE SPOT	1	2011-09-08	5.79		United Kingdom
550514	22489	PACK OF 12 TRADITIONAL CRAYONS	24	2011-04-18	0.42	14631	United Kingdom
569898	23437	50'S CHRISTMAS GIFT BAG LARGE	2	2011-10-06	2.46		United Kingdom
563566	23548	WRAP MAGIC FOREST	25	2011-08-17	0.42	13655	United Kingdom
539492	90209C	PINK ENAMEL+GLASS HAIR COMB	1	2010-12-20	2.11		United Kingdom
559693	21169	YOU'RE CONFUSING ME METAL SIGN	1	2011-07-11	4.13		United Kingdom
...
565378	21155	RED RETROSPOT PEG BAG	7	2011-09-02	4.96		United Kingdom
536592	90214H	LETTER "H" BLING KEY RING	1	2010-12-01	0.85		United Kingdom
...
542633	22382	LUNCH BAG SPACEBOY DESIGN	2	2011-01-31	4.13		United Kingdom
558485	23285	PINK VINTAGE SPOT BEAKER	1	2011-06-30	0.85		United Kingdom
564231	22424	ENAMEL BREAD BIN CREAM	1	2011-08-24	12.75	13468	United Kingdom
578746	84029E	RED WOOLLY HOTTIE WHITE HEART.	25	2011-11-25	9.13		United Kingdom
558564	23176	ABC TREASURE BOOK BOX	3	2011-06-30	2.25	14057	United Kingdom
C559345	21439	BASKET OF TOADSTOOLS	-408	2011-07-07	1.06	13984	United Kingdom
...
562264	23321	SMALL WHITE HEART OF WICKER	3	2011-08-03	3.29		United Kingdom
542541	79030D	TUMBLER, BAROQUE	1	2011-01-28	12.46		United Kingdom
579937	22090	PAPER BUNTING RETROSPOT	12	2011-12-01	2.95	13509	United Kingdom
574076	22483	RED GINGHAM TEDDY BEAR	1	2011-11-02	5.79		United Kingdom
C571707	10135	COLOURING PENCILS BROWN TUBE	-1	2011-10-18	1.25	14056	United Kingdom
565617	84598	BOYS ALPHABET IRON ON PATCHES	3	2011-09-05	0.42		United Kingdom
579187	20665	RED RETROSPOT PURSE	1	2011-11-28	5.79		United Kingdom
...
541975	22382	LUNCH BAG SPACEBOY DESIGN	40	2011-01-24	1.65		Hong Kong
...
543451	22774	RED DRAWER KNOB ACRYLIC EDWARDIAN	1	2011-02-08	2.46		United Kingdom
...
565233	23000	TRAVEL CARD WALLET TRANSPORT	1	2011-09-02	0.83		United Kingdom
559984	16012	FOOD/DRINK SPONGE STICKERS	50	2011-07-14	0.21	16657	United Kingdom
C546997	22398	MAGNETS PACK OF 4 SWALLOWS	-6	2011-03-18	1.25	12748	United Kingdom
...
561369	23009	I LOVE LONDON BABY GIFT SET	1	2011-07-26	24.96		United Kingdom
...
539451	22470	HEART OF WICKER LARGE	3	2010-12-17	5.91		United Kingdom
580730	21126	SET OF 6 GIRLS CELEBRATION CANDLES	1	2011-12-05	1.25		United Kingdom
...
11	22087	PAPER BUNTING WHITE LACE	20	2011-05-28	2.55		United Kingdom
12	22087	PAPER BUNTING WHITE LACE	12	2011-07-28	2.55		United Kingdom
13	22087	PAPER BUNTING WHITE LACE	1	2011-08-28	2.55		United Kingdom
14	22087	PAPER BUNTING WHITE LACE	10	2011-07-28	2.55		United Kingdom
15	22087	PAPER BUNTING WHITE LACE	2	2011-06-28	2.55		United Kingdom
16	22087	PAPER BUNTING WHITE LACE	1	2011-04-28	2.55		United Kingdom
17	22087	PAPER BUNTING WHITE LACE	1	2011-02-28	2.55		United Kingdom
18	22087	PAPER BUNTING WHITE LACE	10	2011-01-28	2.55		United Kingdom
invoiceno:
string
stockcode:
string
...
country:
string
Recommended Hard Interview Questions
'''
...
# Start writing code
df=online_retail
df=df.withColumn("month",month(to_date(col("invoicedate"))))
df=df.withColumn("total_paid",round(col("unitprice")*col("quantity"),2))
df=df.groupby("month","description").agg(sum("total_paid").alias("total_paid"))
df1=df.groupby("month").agg(max("total_paid").alias("max_value"))
df1=df1.withColumnRenamed("month","month1")
# df.show(truncate=False)
# df1.show(truncate=False)
result=df.join(df1,(df.month==df1.month1) & (df.total_paid==df1.max_value)).select("month","description","total_paid")
